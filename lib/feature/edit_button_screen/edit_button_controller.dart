...
//   var existingImageUrl = ''.obs; // existing network image from API
...
//
//     if (itemData!.networkImageUrl != null && itemData!.networkImageUrl!.isNotEmpty) {
//       existingImageUrl.value = itemData!.networkImageUrl!;
//     }
//
//     // ✅ FIX: color যদি availableColors এ না থাকে → default first color নাও
//     if (itemData!.color != null) {
//       final colorInList = availableColors.contains(itemData!.color!);
//       selectedColor.value = colorInList ? itemData!.color! : availableColors.first;
//     }
//   }
//
//   // ==================== SELECT COLOR ====================
...
//         existingImageUrl.value = ''; // clear old network image preview
//       }
//     } catch (e) {
...
//
//   // ==================== AUDIO CONTROLS ====================
//   void playAudio() => Get.snackbar('Audio', 'Play audio');
...
//
//   // ==================== HAS API ID ====================
//   bool get _canCallApi => itemData?.apiId != null && itemData?.apiType != null;
//
//   // ==================== SAVE BUTTON ====================
...
//
//     if (!_canCallApi) {
//       // Static item - just go back (no API for static items)
//       Get.snackbar('Info', 'This is a default item and cannot be edited via API.',
//           snackPosition: SnackPosition.BOTTOM);
//       Get.back();
//       return;
//     }
...
//       final apiId = itemData!.apiId!;
//       final apiType = itemData!.apiType!;
//
//       if (apiType == 'quickspeak') {
//         // PUT: Update quick speak (form-data)
//         response = await _repo.updateUserQuickSpeak(
//           quickSpeakId: apiId,
//           word: word,
//           color: _colorHex,
...
//         // PUT: Update item (form-data)
//         response = await _repo.updateUserItem(
//           itemId: apiId,
//           word: word,
//           color: _colorHex,
//           imageFile: selectedImageFile.value,
//         );
//       } else {
//         // category type - no direct edit API shown, treat as item update
//         response = await _repo.updateUserItem(
//           itemId: apiId,
//           word: word,
//           color: _colorHex,
