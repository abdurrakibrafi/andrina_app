...
//
// class EditButtonScreen extends GetView<EditButtonController> {
//   const EditButtonScreen({super.key});
//
//   @override
...
//             _buildTextField(
//                 controller: controller.wordController, hintText: 'Type the word'),
...
//             const SizedBox(height: 6),
//             _buildTextField(
//                 controller: controller.speakAsController, hintText: 'Speak As'),
//             const SizedBox(height: 6),
//             _buildAudioControls(),
//             const SizedBox(height: 22),
//
...
//     return Row(
//       children: [
//         _buildAudioButton(icon: Icons.volume_up, onTap: controller.playAudio),
...
//     // Priority: newly picked file > existing network URL > placeholder
