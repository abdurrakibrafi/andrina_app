...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'free_plan': 'Free Plan',
      'free_feature_1': 'Limited features',
      'free_feature_2': '1 Caregiver seat',
      'free_feature_3': 'No customization',
      'free_feature_4': 'No notifications',
      'pro_feature_1': 'Full features',
      'pro_feature_2': '2 Caregiver seats',
      'pro_feature_3': 'Push notifications',
      'pro_feature_4': 'Customization options',
      'pro_feature_5': 'Add-ons: Extra caregiver seats\n& Multiple profiles',
    ...
    'es_ES': {
      ...
      'free_feature_1': 'Funciones limitadas',
      'free_feature_2': '1 lugar para cuidador',
      'free_feature_3': 'Sin personalización',
      'free_feature_4': 'Sin notificaciones',
      'pro_feature_1': 'Funciones completas',
      'pro_feature_2': '2 lugares para cuidadores',
      'pro_feature_3': 'Notificaciones push',
      'pro_feature_4': 'Opciones de personalización',
      'pro_feature_5': 'Complementos: Lugares extra\ny Perfiles múltiples',
